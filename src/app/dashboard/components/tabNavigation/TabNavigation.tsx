...
>(({ className, children, ...props }, forwardedRef) => (
  ...
  >
    <NavigationMenuPrimitives.List
      className={cx(
        // base
        "flex items-center justify-center  whitespace-nowrap border-b [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
        // border color
    ...
    >
      {getSubtree({ asChild, children }, (children) => (
        <span
          className={cx(
            // base
            "-mb-px flex items-center justify-center whitespace-nowrap border-b-2 border-transparent px-3 pb-2 text-xl font-medium transition-all",
            // text color
